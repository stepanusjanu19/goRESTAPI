...
func (server *Server) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Lacation", fmt.Sprintf("%s%s/%d", r.Host, r.URL.Path, postCreated.POST_ID))
...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	postUpdate.POST_ID = post.POST_ID //this is important to tell the model the post id to update, the other update field are set above
